...
import { Hospital, Calendar, FileText, User, Package, MessageSquare, CheckSquare, LogOut, Plus, Edit, Trash2 } from "lucide-react"
    ...
    <div className="flex h-screen bg-gray-900 text-gray-100">
      ...
      <aside className="w-64 bg-gray-800 p-4">
        <div className="flex items-center mb-6">
          ...
          <span className="text-xl font-bold text-blue-400">HealthConnect</span>
        </div>
